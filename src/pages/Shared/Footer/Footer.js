...
const Footer = () => {
    return (
        <div className='pt-10 bg-gray-800'>
            ...
            <p className='text-center text-white font-semibold text-xl py-5 mt-5 border-t-2 border-red-500'>All right reserved to <span className='text-2xl'>MCH Cars</span> &copy; 2021</p>
        </div>
    );
};
